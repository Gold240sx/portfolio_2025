			...
			<Container style={container}>
				...
				<Section style={message}>
					...
					<Text style={global.text}>
						You order's is on its way. Use the link above to track
						its progress.
					</Text>
					...
					<Row>
						...
						<Column
							...
							<Text style={{ ...paragraph, fontWeight: "500" }}>
								Brazil 2022/23 Stadium Away Women's Nike Dri-FIT
								Soccer Jersey
							</Text>
				...
				<Section style={paddingY}>
					...
					<Text style={footer.text}>
						NIKE, INC. One Bowerman Drive, Beaverton, Oregon 97005,
						USA.
					</Text>
				</Section>
			</Container>
