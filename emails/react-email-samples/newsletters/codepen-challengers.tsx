			...
			<Container style={container}>
				...
				<Section style={section}>
					...
					<Text style={text}>
						...
						<Link style={blueLink}>#CodePenChallenge: Round</Link>{" "}
						collection.
					</Text>
					...
					<Text style={text}>
						...
						illusion. Take control of perspective and shadows and
						you can make the magic of 3D on a flat screen 🧙
					</Text>
					...
					<Text style={text}>
						This week's starter template features an ice cube emoji
						to help inspire a "cool" idea for your Pen. As always,
						the template is just as jumping off point. Feel free to
						incorporate the 🧊 in your creation, add more elements,
						or freeze it out completely and start over from scratch!
					</Text>
				...
				<Text style={yellowSection}>
					...
					<Link style={blueLink}>Twitter</Link> and{" "}
					<Link style={blueLink}>Instagram</Link> (Use the
						...
						<Column style={ideas}>
							...
							<Section style={yellowCard}>
								...
								<Text style={textCard}>
									...
									<Link style={blueLink}>perspective</Link> in
									CSS to create a 3D cube. Or, you can try out
									creating 3D shapes in JavaScript, using{" "}
									<Link style={blueLink}>WebGL</Link> or
									building a{" "}
							...
							<Section style={yellowCard}>
								🌟
								<Text style={textCard}>
									There's more to cubes than just six square
									sides. There are variations on the cube that
									could be fun to play with this week:{" "}
									<Link style={blueLink}>cuboid shapes</Link>{" "}
									are hexahedrons with faces that aren't
									always squares. And if you want to really
									push the boundaries of shape, consider the 4
									dimensional{" "}
							...
							<Section style={yellowCard}>
								🌟
								<Text style={textCard}>
									Here's a mind-bending idea that can combine
									the round shapes from week one with this
									week's cube theme:{" "}
									<Link style={blueLink}>
										Spherical Cubes
									</Link>{" "}
									😳 Solving longstanding mathematical
									mysteries is probably outside the scope of a
									CodePen challenge, but you could use
						...
						<Column style={resources}>
							...
							<Section style={blueCard}>
								...
								<Text style={textCard}>
									...
									and how to build a 3D CSS cube from scratch
									in Amit Sheen's in-depth tutorial for
									CSS-Tricks. Or, check out stunning examples
									of WebGL cubes from Matthias Hurrle:{" "}
							...
							<Section style={blueCard}>
								📖
								<Text style={textCard}>
									Did that spherical cubes concept pique your
									interest? Explore Ryan Mulligan's{" "}
									<Link style={blueLink}>Cube Sphere</Link>,
									Munir Safi's{" "}
									<Link style={blueLink}>
										3D Sphere to Cube Animation With Virtual
										Trackball
									</Link>{" "}
									and Ana Tudor's{" "}
									<Link style={blueLink}>
									...
									for more mindbending cube concepts that test
									the boundaries of how shapes interact with
									each other.
								</Text>
							</Section>
						</Column>
				...
				<Section style={footer}>
					<Text style={footerText}>
						You can adjust your{" "}
						<Link style={footerLink}>email preferences</Link> any
						time, or{" "}
						<Link style={footerLink}>instantly opt out</Link> of
						emails of this kind. Need help with anything? Hit up{" "}
