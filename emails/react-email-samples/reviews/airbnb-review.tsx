			...
			<Body style={main}>
				<Section style={main}>
					<Container style={container}>
						<Section>
							<Text style={heading}>Base URL: {baseUrl}</Text>
							<Img
						...
						<Section style={{ paddingBottom: "20px" }}>
							<Row>
								...
								<Text style={paragraph}>
									Now that the review period is over, we’ve
									posted {authorName}
								...
								<Text
									...
									While it’s too late to write a review of
									your own, you can send your feedback to{" "}
									{authorName} using your Airbnb message
									thread.
								</Text>
						...
						<Section>
							<Row>
								...
								<Hr style={hr} />
								<Text style={footer}>
									Airbnb, Inc., 888 Brannan St, San Francisco,
									CA 94103
								</Text>
								<Link
									href="https://airbnb.com"
