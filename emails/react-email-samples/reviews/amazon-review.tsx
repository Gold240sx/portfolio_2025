					...
					<Section>
						<Row>
							...
							<Column style={ratingContent}>
								...
								<Text>
									Your reviews will be posted on Amazon using
									your public name.
						...
						<Row>
							<Column align="center">
								<Text style={previewPurchase}>
									...
									<Link style={previewPurchaseLink}>
										View more
									</Link>
								</Text>
							</Column>
					...
					<Section>
						<Row>
							...
							<Text style={footerText}>
								...
								However, if you prefer not to receive this type
							...
							<Text style={footerText}>
								Please note that product prices and availability
								are subject to change.
							</Text>
							<Text style={footerText}>
								© 2023 Amazon.com, Inc. or its affiliates.
								Amazon and all associated marks are trademarks
