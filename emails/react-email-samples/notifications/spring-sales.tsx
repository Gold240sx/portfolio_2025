import { Html, Head, Preview, Body, Container, Link, Img, Text, Section, Hr, Row, Column } from "@react-email/components"
			...
			<Container style={parentContainer}>
				...
				<Container style={container}>
					...
					<Text style={paragraph}>
						Spring is in full swing, and what better way to celebrate the season of new beginnings than with fresh flowers? Our
						beautiful collection of blooms is now available at discounted prices that you don't want to miss!
					</Text>
					...
					<Section>
						...
						<Section>
							<Link href="#">
								<Row>
									<Column align="left">
										<Img src={`${baseUrl}/plant.jpg`} width="145" height="120" alt="Karupu Plant" style={plantImg} />
									</Column>
									<Column style={plantCopy}>
										<Text style={plantName}>Karupu Plant</Text>
										<Text>This plant is a rare breed and grows up to 1-5 meters.</Text>
									</Column>
								</Row>
							</Link>
						</Section>
							...
							<Row>
								<Column align="left">
									<Link href="#" style={socialIcon}>
										<Img src={`${baseUrl}/twitter.png`} height="19" width="19" />
									</Link>
								</Column>
								<Column align="center">
									<Link href="#" style={socialIcon}>
										<Img src={`${baseUrl}/instagram.png`} height="19" width="19" />
									</Link>
								</Column>
								<Column align="right">
									<Link href="#" style={socialIcon}>
