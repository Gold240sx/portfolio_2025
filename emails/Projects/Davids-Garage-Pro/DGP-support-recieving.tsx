...
const DGPSupportRecieving = () => (
	<Tailwind
		...
		<Html style={main} className="m-0 p-0">
			<Head />
			<Preview>
				DGP: {data.firstName || data.name} {data.lastName} - Support
				Ticket
			</Preview>
			<Body
				style={main}
				...
				<Img
					src={"https://i.ibb.co/NLnCL1L/support.png"}
					width="85%"
					height="auto"
					className="pl-2 pr-6 mx-auto flex"
					alt="icon"
				/>
				<Container className="mx-auto my-0 mb-9 md:mb-16 bg-zinc-800">
					...
					<Section className=" py-0">
						<Section className="pb-0 mt-4 px-4">
							<Text
								style={paragraph}
							...
							<tbody>
								{data.name && (
									<tr className="px-4 py-2 ml-2 font-semibold bg-black/20 text-zinc-500">
										...
										<td className="px-4 py-2 text-zinc-500 capitalize font-thin tracking-wide">
											{data.name}
										</td>
									</tr>
								)}
								{data.email && (
									<tr className="px-4 py-2 ml-2 font-semibold bg-black/20 text-zinc-500">
										...
										<Link href={`mailto:${data.email}`}>
											<td className="px-4 py-2 text-zinc-500 font-thin tracking-wide">
												{data.email}
											</td>
										</Link>
									</tr>
						...
						<div className="flex flex-col justify-between bg-black/40 p-4 mt-6 m-2">
							<Text className="text-2xl font-thin text-white">
								Support Inquiry
							</Text>
							<Text className="text-xl font-thin text-zinc-100 mx-auto w-fit  text-balance">
								<span className="font-semibold text-6xl text-zinc-600">
									"
								</span>
								{data.message}
								<span className="font-semibold text-6xl text-zinc-600">
						...
						<div className="flex gap-4 my-8 mx-4 md:mx-auto w-fit mb-12">
							<Button
								...
								<span className="flex my-auto mt-0.5 md:py-4 md:px-5">
									Reply by Email
								</span>
							</Button>
							<Button
								...
								<span className="flex my-auto h-fit mt-0.5 md:mt-0 md:py-4 md:px-5">
									Reply by Text
								</span>
							</Button>
							<Button
...
export default DGPSupportRecieving
