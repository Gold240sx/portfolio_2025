	...
	return (
		<Tailwind
			...
			<Html style={main} className="m-0 p-0">
				<Head />
				<Preview>
					DGP: {firstName || data.name} {lastName} - QRCode Submission
				</Preview>
				<Body
					style={main}
					...
					<Container className="mx-auto my-0 mb-9 md:mb-16 bg-zinc-800">
						...
						<Section className=" py-0 mb-16">
							...
							<Text className="text-5xl p-4 font-thin text-[#8898aa] mt-10">
								Data Submitted:
							</Text>
...
export default DGPDataRecieving
