...
const DGPSupportTicketRecieved = () => (
	<Tailwind
		config={{
			theme: {
				extend: {
		...
		<Html style={main} className="m-0 p-0">
			<Head />
			<Preview>David's Garage Pro - Support Ticket Submission</Preview>
			<Body
				style={main}
				...
				<Container className="mx-auto my-0 mb-9 md:mb-16 bg-zinc-800">
					...
					/>
					<Section className="pt-12 bg-white px-8">
						<Text style={paragraph} className="text-black text-2xl">
							Your Quote inquiry has been recieved by our team!
						</Text>
						<Text style={paragraph} className="text-gray-600 ">
							Thank you for submitting a support request with us!
							We have recieved your message and will get back to
							you as soon as possible! Please be aware that delays
							may occur on Saturdays, and peak times.
						</Text>
						<Text style={paragraph} className="text-zinc-600">
							If you have any further updates or details you would
							like to include,{" "}
							<span className="underline tracking-wide font-semibold">
								you can contact us directly by replying to this
								email.
							</span>{" "}
							This helps keep all of our communication in one
							place.
						</Text>
						<Link href="mailto:info@davidsgarage.pro">
							<div className="flex gap-4 items-center">
								<Img
									...
									height={40}
								/>
								<Text className="text-amber-400 text-xl md:text-3xl my-4 pl-2">
									{" "}
					...
					<Img
						src={"https://i.ibb.co/pd22Z3c/HireMe.gif"}
						width="100%"
						height="auto"
						alt="icon"
					/>
					<Section className="px-4 md:px-12 py-0 bg-[#01313F]">
						<Text className="text-6xl font-thin text-zinc-400">
							Message delivered:
						</Text>
						<div className="flex justify-between">
							<Text className="text-2xl font-thin text-white">
								User Details:
							</Text>
							<Text className="text-xl font-thin text-amber-400">
								{data.time} - {data.date}
							</Text>
						</div>
						...
						<table>
							<thead className="">
								{/* <tr className="">
									<th className="px-4 py-2 font-semibold  bg-black/40 text-zinc-500">
										Field
									</th>
									<th className="px-4 py-2 ml-2 font-semibold bg-black/40 text-zinc-500">
										Value
									</th>
								</tr> */}
							</thead>
							<tbody>
								{data.name && (
									<tr className="px-4 py-2 ml-2 font-semibold bg-black/20 text-zinc-500">
										<td className="px-4 py-2 text-zinc-500">
											Name
										</td>
										<td className="px-4 py-2 capitalize font-thin tracking-wide text-white">
											{data.name}
										</td>
									</tr>
								)}
								{data.email && (
									<tr className="px-4 py-2 ml-2 font-semibold bg-black/20 text-zinc-500">
										...
										<Link href={`mailto:${data.email}`}>
											<td className="px-4 py-2 font-thin tracking-wide text-white">
												{data.email}
											</td>
										</Link>
									</tr>
						...
						<div className="flex flex-col justify-between bg-black/40 p-4 my-6">
							<Text className="text-2xl font-thin text-white">
								Support Inquiry
							</Text>
							<Text
								id="message"
								className="text-xl font-thin text-zinc-100 mx-auto w-fit  text-balance relative">
								<span className="font-semibold text-6xl text-zinc-600 mb-1">
									"
								</span>
								{data.message}
								<span
...
export default DGPSupportTicketRecieved
