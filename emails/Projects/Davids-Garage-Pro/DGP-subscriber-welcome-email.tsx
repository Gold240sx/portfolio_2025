...
const DGPSubscriberWelcomeEmail = () => (
	<Tailwind
		config={{
			theme: {
				extend: {
		...
		<Html style={main} className="m-0 p-0">
			<Head />
			<Preview>David's Garage Pro - Welcome!</Preview>
			<Body
				style={main}
				...
				<Container className="mx-auto my-0 mb-9 md:mb-16 bg-zinc-800">
					...
					<Section className=" py-0">
						...
						<Section className="pt-6 pb-12 bg-zinc-800 px-8">
							<Text
								style={paragraph}
								className="text-white text-2xl">
								You've subscribed to Davids Garage Pro!
							</Text>
							<Text
								style={paragraph}
								className="text-gray-200 indent-3">
								Hello {data.firstName}, We're excited to have
								you on board! You've successfully subscribed to
								Davids Garage Pro. We are thrilled to have you
...
export default DGPSubscriberWelcomeEmail
