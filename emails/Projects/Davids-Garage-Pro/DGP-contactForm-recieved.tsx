	...
	return (
		<Tailwind
			...
			<Html style={main} className="m-0 p-0">
				<Head />
				<Preview>David's Garage Pro - Contact Form Submitted</Preview>
				<Body
					style={main}
					...
					<Container className="mx-auto my-0 mb-9 md:mb-16 bg-zinc-800">
						...
						<Section className="px-12 py-0">
							...
							<Text
								...
								We have recieved your contact form submission
								and will get back to you as soon as we can!
								Please be aware that delays may occur on
								Saturdays, and peak times.
							</Text>
...
export default DGPContactFormRecieved
